const dino = document.getElementById("game-dino");
 ...
 const winnerForm = document.getElementById("game-winner-form");
 const lockForm = document.getElementById("form-lock");
 const lockForm1 = document.getElementById("form-lock-1");
 ...
 const stopGame = async () => {
   ...
   if (Number(score.innerText) + 1 >= POINTS_TO_WIN) {
     ...
     lockForm1.classList.add("hidden");
   }
 };
